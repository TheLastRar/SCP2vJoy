...
{
    class HidReportDescFfb
    {
        public const byte HID_ID_STATE = 0x02;

        const byte TLID = 0;

        public static byte[][] FfbDescriptor = new byte[][] { new byte[] {
		...
		0x85, },
        new byte[] { (byte)(HidReportDescFfb.HID_ID_STATE + 0x10 * TLID),    //    Report ID 2
		...
		/*
			...
			*/
			...
			0xA1, 0x02,    //    Collection Datalink (Logical)
			0x85, },
            new byte [] { (byte)(FFBPType.PT_EFFREP + 0x10 * TLID),    //    Report ID 1
			0x09, 0x22,    //    Usage Effect Block Index
			0x15, 0x01,    //    Logical Minimum 1
			0x25, 0x28,    //    Logical Maximum 28h (40d)
			0x35, 0x01,    //    Physical Minimum 1
			...
			0x09, HidFfbEffects.HID_USAGE_CONST,    //    Usage ET Constant Force
			0x09, HidFfbEffects.HID_USAGE_RAMP,    //    Usage ET Ramp
			0x09, HidFfbEffects.HID_USAGE_SQUR,    //    Usage ET Square
			0x09, HidFfbEffects.HID_USAGE_SINE,    //    Usage ET Sine
			0x09, HidFfbEffects.HID_USAGE_TRNG,    //    Usage ET Triangle
			0x09, HidFfbEffects.HID_USAGE_STUP,    //    Usage ET Sawtooth Up
			0x09, HidFfbEffects.HID_USAGE_STDN,    //    Usage ET Sawtooth Down
			0x09, HidFfbEffects.HID_USAGE_SPRNG,    //    Usage ET Spring
			0x09, HidFfbEffects.HID_USAGE_DMPR,    //    Usage ET Damper
			0x09, HidFfbEffects.HID_USAGE_INRT,    //    Usage ET Inertia
			0x09, HidFfbEffects.HID_USAGE_FRIC,    //    Usage ET Friction
...
//			0x09, 0x28,    //    Usage ET Custom Force Data
			...
			0xA1, 0x02,    //    Collection Datalink
			0x85, }, new byte[] { (byte)(FFBPType.PT_ENVREP + 0x10 * TLID),         //    Report ID 2
			0x09, 0x22,         //    Usage Effect Block Index
			0x15, 0x01,         //    Logical Minimum 1
			0x25, 0x28,         //    Logical Maximum 28h (40d)
			0x35, 0x01,         //    Physical Minimum 1
			...
			0xA1, 0x02,    //    Collection Datalink
			0x85, }, new byte[] { (byte)(FFBPType.PT_CONDREP + 0x10 * TLID),    //    Report ID 3
			0x09, 0x22,    //    Usage Effect Block Index
			0x15, 0x01,    //    Logical Minimum 1
			0x25, 0x28,    //    Logical Maximum 28h (40d)
			0x35, 0x01,    //    Physical Minimum 1
			...
			0xA1, 0x02,    //    Collection Datalink
			0x85, }, new byte[] { (byte)(FFBPType.PT_PRIDREP + 0x10 * TLID),                   //    Report ID 4
			0x09, 0x22,                   //    Usage Effect Block Index
			0x15, 0x01,                   //    Logical Minimum 1
			0x25, 0x28,                   //    Logical Maximum 28h (40d)
			0x35, 0x01,                   //    Physical Minimum 1
			...
			0xA1, 0x02,    //    Collection Datalink
			0x85, }, new byte[] { (byte)(FFBPType.PT_CONSTREP + 0x10 * TLID),         //    Report ID 5
			0x09, 0x22,         //    Usage Effect Block Index
			0x15, 0x01,         //    Logical Minimum 1
			0x25, 0x28,         //    Logical Maximum 28h (40d)
			0x35, 0x01,         //    Physical Minimum 1
			...
			0xA1, 0x02,    //    Collection Datalink
			0x85, }, new byte[] { (byte)(FFBPType.PT_RAMPREP + 0x10 * TLID),         //    Report ID 6
			0x09, 0x22,         //    Usage Effect Block Index
			0x15, 0x01,         //    Logical Minimum 1
			0x25, 0x28,         //    Logical Maximum 28h (40d)
			0x35, 0x01,         //    Physical Minimum 1
			...
			0xA1, 0x02,    //    Collection Datalink
			0x85, }, new byte[] { (byte)(FFBPType.PT_CSTMREP + 0x10 * TLID),         //    Report ID 7
			0x09, 0x22,         //    Usage Effect Block Index
			0x15, 0x01,         //    Logical Minimum 1
			0x25, 0x28,         //    Logical Maximum 28h (40d)
			0x35, 0x01,         //    Physical Minimum 1
			...
			0xA1, 0x02,    //    Collection Datalink
			0x85, }, new byte[] { (byte)(FFBPType.PT_SMPLREP + 0x10 * TLID),         //    Report ID 8
			0x05, 0x01,         //    Usage Page Generic Desktop
			0x09, 0x30,         //    Usage X
			0x09, 0x31,         //    Usage Y
			0x15, 0x81,         //    Logical Minimum 81h (-127d)
			...
			0xA1, 0x02,   //    Collection Datalink
			0x85, }, new byte[] { (byte)(FFBPType.PT_EFOPREP + 0x10 * TLID),    //    Report ID Ah (10d)
			0x09, 0x22,    //    Usage Effect Block Index
			0x15, 0x01,    //    Logical Minimum 1
			0x25, 0x28,    //    Logical Maximum 28h (40d)
			0x35, 0x01,    //    Physical Minimum 1
			...
			0xA1, 0x02,    //    Collection Datalink
			0x85, }, new byte[] { (byte)(FFBPType.PT_BLKFRREP + 0x10 * TLID),    //    Report ID Bh (11d)
			0x09, 0x22,    //    Usage Effect Block Index
			0x25, 0x28,    //    Logical Maximum 28h (40d)
			0x15, 0x01,    //    Logical Minimum 1
			0x35, 0x01,    //    Physical Minimum 1
			...
			0xA1, 0x02,    //    Collection Datalink
			0x85, }, new byte[] { (byte)(FFBPType.PT_CTRLREP + 0x10 * TLID),    //    Report ID Ch (12d)
			...
			0xA1, 0x02,    //    Collection Datalink
			0x85, }, new byte[] { (byte)(FFBPType.PT_GAINREP + 0x10 * TLID),         //    Report ID Dh (13d)
			...
			0xA1, 0x02,    //    Collection Datalink
			0x85, }, new byte[] { (byte)(FFBPType.PT_SETCREP + 0x10 * TLID),         //    Report ID Eh (14d)
			0x09, 0x22,         //    Usage Effect Block Index
			0x15, 0x01,         //    Logical Minimum 1
			0x25, 0x28,         //    Logical Maximum 28h (40d)
			0x35, 0x01,         //    Physical Minimum 1
			...
			0xA1, 0x02,    //    Collection Datalink
			0x85, }, new byte[] { (byte)(FFBPType.PT_NEWEFREP - 0x10 + 0x10 * TLID),    //    Report ID 1
			0x09, 0x25,    //    Usage Effect Type
			0xA1, 0x02,    //    Collection Datalink
			0x09, HidFfbEffects.HID_USAGE_CONST,    //    Usage ET Constant Force
			0x09, HidFfbEffects.HID_USAGE_RAMP,    //    Usage ET Ramp
...
//			0x09, 0x28,    //    Usage ET Custom Force Data
			...
			0xA1, 0x02,    //    Collection Datalink
			0x85, }, new byte[] { (byte)(FFBPType.PT_BLKLDREP - 0x10 + 0x10 * TLID),    //    Report ID 2
			0x09, 0x22,    //    Usage Effect Block Index
			0x25, 0x28,    //    Logical Maximum 28h (40d)
			0x15, 0x01,    //    Logical Minimum 1
			0x35, 0x01,    //    Physical Minimum 1
			...
			0xA1, 0x02,    //    Collection Datalink
			0x85, }, new byte[] { (byte)(FFBPType.PT_POOLREP - 0x10 + 0x10 * TLID),                   //    Report ID 3
